...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      'body[data-dsh-maid-atelier]:not([data-ds-dark-theme]) .dshw_footRing{--dsw-alias-label-primary:#172347;--dsw-alias-label-secondary:#40557f;--dsw-alias-label-tertiary:#5f7093;--dsw-alias-border-l1:rgba(88,111,166,.42);--dsw-alias-border-l3:rgba(72,93,145,.35);--dsw-alias-interactive-bg-hover:rgba(221,230,247,.98);color:#172347;background:rgba(238,243,252,.95);border-color:rgba(88,111,166,.42);box-shadow:inset 0 1px rgba(255,255,255,.7),0 3px 10px rgba(29,50,96,.12)}',
