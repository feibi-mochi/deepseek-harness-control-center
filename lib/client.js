...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.dshw_muted{color:var(--dsw-alias-label-tertiary,#8b949e)}',
      ...
      '.dshw_balSub .dshw_balDot{color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e))}',
      ...
      '.dshw_acctMore{display:flex;justify-content:flex-end;font-size:10.5px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e));margin-top:3px}',
      ...
      '.dshw_acctKey{font-family:ui-monospace,Consolas,monospace;font-size:10px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1 1 auto}',
      ...
      '.dshw_settingsLead{margin-top:2px;font-size:11.5px;color:var(--dsw-alias-label-tertiary,#8b949e)}',
      '.dshw_versionBadge{flex:none;padding:2px 7px;border-radius:999px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-bg-layer-1,rgba(127,127,127,.1)));color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e));font-size:10px}',
      ...
      '.dshw_settingsHeroLabel{font-size:11.5px;color:var(--dsw-alias-label-tertiary,#8b949e)}',
      ...
      '.dshw_settingsHeroMeta{display:flex;align-items:center;gap:7px;margin-top:9px;color:var(--dsw-alias-label-tertiary,#8b949e);font-size:11px;white-space:nowrap}',
      ...
      '.dshw_settingsGroupHint{margin-top:2px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e));font-size:10.5px}',
      ...
      '.dshw_settingsFieldLabel>span{font-size:10px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e))}',
      ...
      '.dshw_settingChoiceCopy span{font-size:9.5px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e));white-space:nowrap;overflow:hidden;text-overflow:ellipsis}',
      ...
      '.dshw_accountCount{font-size:10.5px;color:var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e))}',
      ...
      '.dshw_footRingResetBtn{position:absolute;top:4px;right:6px;font-size:10px;padding:1px 6px;border-radius:4px;border:1px solid var(--dsw-alias-border-l1,rgba(127,127,127,.2));background:var(--dsw-alias-bg-layer-2,transparent);color:var(--dsw-alias-label-tertiary,#8b949e);cursor:pointer;line-height:14px}',
    ...
    function PeakRingFooter(props) {
      ...
      var panelElement = panelOpen ? React.createElement('div', {
        ...
        React.createElement('div', { style: { marginTop: '4px', textAlign: 'right', fontSize: '10px', color: 'var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e))' } },
    ...
    function WalletChip(props) {
      ...
      var panel = React.createElement('div', {
        ...
        showOfficial ? React.createElement(React.Fragment, null,
          ...
          React.createElement('div', { className: 'dshw_divider' })) : null,
        accountsSection(),
        React.createElement('div', { style: { marginTop: '8px', textAlign: 'right', fontSize: '10px', color: 'var(--dsw-alias-label-dimmed,var(--dsw-alias-label-tertiary,#8b949e))', userSelect: 'none' } }, 'DeepSeek Harness Control Center v' + WALLET_VERSION)
      )
