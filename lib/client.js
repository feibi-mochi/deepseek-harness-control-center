...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var css = [
      ...
      '.dshw_chipTextOnly{border-color:transparent!important;background:transparent!important;box-shadow:none!important}.dshw_chipTextOnly .dshw_chipMain{padding-inline:2px}.dshw_chipTextOnly .dshw_recharge{border-left:0;padding-inline:5px;background:transparent!important;box-shadow:none!important}',
      'body[data-dsh-maid-atelier] .dshw_anchorHome{min-height:38px}',
      'body[data-dsh-maid-atelier] .dshw_anchorHome>.dshw_chip{height:38px;border-color:var(--dsw-alias-border-l2,rgba(211,180,119,.66));background:var(--dsw-alias-button-elevated-fill,rgba(28,44,84,.72));box-shadow:0 3px 10px rgba(1,7,24,.2),inset 0 0 0 3px rgba(255,255,255,.04);backdrop-filter:blur(3px)}',
      ...
      'body[data-dsh-maid-atelier] .dshw_anchorHome>.dshw_chipTextOnly{border-color:transparent;background:transparent;box-shadow:none;backdrop-filter:none}',
    ...
    function normalizeChipStyle(value) {
      return value === 'text' || value === 'hidden' ? value : 'standard'
    }
    ...
    function WalletSettingsSection(props) {
      ...
      cells.push(React.createElement('div', { key: 'chip-style', className: 'dshw_setCell' },
        React.createElement('span', { className: 'dshw_settingsFieldLabel' },
          ...
          React.createElement('span', null, chipStyle === 'hidden' ? '已隐藏；提醒与设置仍运行' : chipStyle === 'text' ? '仅显示文字，不显示外框' : '完整标签与操作按钮')),
        React.createElement('span', { className: 'dshw_balFill' }),
        React.createElement('select', {
          className: 'dshw_select',
          'aria-label': '输入框标签样式',
          value: chipStyle,
          onChange: function (event) { persistChipStyle(event.target.value) }
        },
          React.createElement('option', { value: 'standard' }, '标准'),
          React.createElement('option', { value: 'text' }, '纯文字'),
    ...
    function WalletChip(props) {
      ...
      if (chipAppearance === 'text') chipClass += ' dshw_chipTextOnly'
