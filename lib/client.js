...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PlanUsagePanel(props) {
      ...
      var shown = compact ? sources.filter(function (source) { return source.configured === true || source.available }) : sources
    ...
    function WalletChip(props) {
      ...
      var panel = React.createElement('div', {
        ...
        React.createElement(PlanUsagePanel, { key: 'plans-compact', compact: true }),
        accountsSection(),
        React.createElement('div', { style: { marginTop: '8px', textAlign: 'right', fontSize: '10px', color: 'var(--dsw-alias-label-secondary,var(--dsw-alias-label-tertiary,#667085))', userSelect: 'none' } }, 'DeepSeek Harness Control Center v' + WALLET_VERSION)
      )
      ...
      if (floated) {
        ...
        var floatPanel = React.createElement('div', {
          ...
          React.createElement(PlanUsagePanel, { key: 'plans-float', compact: true }),
          accountsSection(),
          React.createElement('div', { style: { marginTop: '8px', textAlign: 'right', fontSize: '10px', color: 'var(--dsw-alias-label-secondary,var(--dsw-alias-label-tertiary,#667085))', userSelect: 'none' } }, 'DeepSeek Harness Control Center v' + WALLET_VERSION)
        )
