...
- Treat maintenance and incremental feature work as patch updates whenever possible. This release is `0.3.11`; use the next patch version for future maintenance. Never publish a lower version afterward.
