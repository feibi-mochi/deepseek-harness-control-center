...
- Treat maintenance and incremental feature work as patch updates whenever possible. The working version is `0.3.12` (unreleased); the last published version is `0.3.11`. Never publish a lower version afterward.
