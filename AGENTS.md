...
- Treat maintenance and incremental feature work as patch updates whenever possible. After a published `0.3.2`, the next small release is `0.3.3`; never publish a lower `0.2.x` version afterward.
